...
module.exports = {
  async up (queryInterface) {
   const tournamentsData = [
     {title:'Открытый турнир', description:'История и развитие нефтегазовой отрасли России', time: '8 Апреля 2024, 14:00', img: 'https://sun9-76.userapi.com/impg/uHW1gsm0-Gncys7zEGodU_ltLW4sIR0aSYCEuQ/JpOAk3Cdr1M.jpg?size=670x459&quality=96&sign=27ab352c5262360a83abc02584493360&type=album'},
