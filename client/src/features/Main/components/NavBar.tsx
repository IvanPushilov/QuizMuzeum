  ...
  return (
    <nav className="page__menu page__custom-settings menu">
      ...
      <li className="menu__group">
        <NavLink className='link-vk' to='https://vk.com/synergyoil86'target='_blank'>
      ...
      <li>
<NavLink className='link-home' to='/' ><img width="40px" height="40px" src='../../../../public/profileImg/home.png'/></NavLink>
      </li>
